...
<head>
  ...
  <link rel="icon" href="view\images\icons\favicon.ico">
  ...
  <div class="container">
    <form class="form-signin" method="post" action="model/proses.php">
      <h2 class="form-signin-heading">
        <center>Aplikasi Absensi Siswa
      </h2><br>
      <img src="view\images\img-01.png" alt="IMG"><br>
      <?php
      if (isset($_GET['log'])) {
        if ($_GET['log'] == 2) {
...
<footer>&copy; Copyright 2020 Mochammad Dennis Alfarizi</footer>
